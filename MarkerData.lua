...
ModernMapMarkers_Points = {
	...
	{1, 9, 0.53, 0.76, "Onyxias Hort", "raid", "60", 8},
    ...
    {2, 36, 0.423, 0.726, "Die Todesminen", "dungeon", "17-24", 22},
    {2, 15, 0.30, 0.27, "Stadt von Gilneas", "dungeon", "43", 4},
    {2, 9, 0.248, 0.337, "Gnomeregan", "dungeon", "29-38", 5},
    {2, 5, 0.95, 0.53, "Hassschmiede Steinbruch", "dungeon", "52-60", 6},
    {2, 13, 0.45, 0.75, "Karazhan Krypta", "dungeon", "58-60", 7},
    {2, 5, 0.321, 0.386, "Untere Schwarzfelsspitze", "dungeon", "55-60", 8},
	{2, 24, 0.364, 0.879, "Untere Schwarzfelsspitze", "dungeon", "55-60", 8},
    {2, 30, 0.869, 0.323, "Scharlachrotes Kloster – Waffenkammer", "dungeon", "32-42", 12}, 
    {2, 30, 0.862, 0.295, "Scharlachrotes Kloster – Kathedrale", "dungeon", "35-45", 13}, 
    {2, 30, 0.839, 0.283, "Scharlachrotes Kloster – Friedhof", "dungeon", "26-36", 14},
    {2, 30, 0.850, 0.338, "Scharlachrotes Kloster – Bibliothek", "dungeon", "29-39", 15},
    {2, 37, 0.69, 0.74, "Scholomance", "dungeon", "58-60", 16},
    {2, 25, 0.44, 0.67, "Burg Schattenfang", "dungeon", "22-30", 17},
    {2, 26, 0.51, 0.675, "Das Verlies", "dungeon", "24-31", 23},
    {2, 26, 0.63, 0.58, "Tresor von Sturmwind", "dungeon", "60", 18},
    {2, 35, 0.29, 0.61, "Tresor von Sturmwind - Horde Eingang", "dungeon", "60", 18},
    {2, 39, 0.31, 0.14, "Stratholme", "dungeon", "58-60", 20},
    {2, 39, 0.47, 0.24, "Stratholme – Hintereingang", "dungeon", "58-60", 20},
    {2, 28, 0.701, 0.55, "Der Versunkene Tempel", "dungeon", "50-60", 21},
	...
	{2, 27, 0.67, 0.634, "Zuflucht des Drachenmals", "dungeon", "27-33", 3},
	{2, 4, 0.57, 0.598, "Ruine von Sturmschmied", "dungeon", "35-41", 19},
	-- Eastern Kingdoms Raids
	{2, 24, 0.332, 0.851, "Pechschwingenhort", "raid", "60", 2},
	{2, 5, 0.273, 0.363, "Pechschwingenhort", "raid", "60", 2},
	{2, 13, 0.46, 0.70, "Untere Hallen von Karazhan", "raid", "58-60", 9},
	{2, 24, 0.336, 0.879, "Geschmolzener Kern", "raid", "60", 10},
	{2, 5, 0.273, 0.387, "Geschmolzener Kern", "raid", "60", 10},
	{2, 39, 0.40, 0.28, "Naxxramas", "raid", "60", 11},
	{2, 13, 0.442, 0.719, "Turm von Karazhan", "raid", "60", 24},
	{2, 23, 0.53, 0.172, "Zul'Gurub", "raid", "60", 27},
	-- Eastern Kingdoms World Bosses
	{2, 13, 0.471, 0.751, "Dunkler Plünderer von Karazhan", "worldboss", "60", nil},
	{2, 10, 0.465, 0.357, "Smaragddrache – Erscheinungspunkt 3 von 4", "worldboss", "60", nil},
	{2, 17, 0.632, 0.217, "Smaragddrache – Erscheinungspunkt 4 von 4", "worldboss", "60", nil},
	{2, 33, 0.36, 0.753, "Lord Kazzak", "worldboss", "60", nil},
	{2, 39, 0.082, 0.38, "Nerubischer Aufseher", "worldboss", "60", nil},
	-- Eastern Kingdoms Transport
	{2, 26, 0.694, 0.294, "Tiefenbahn nach Eisenschmiede", "tram", "Allianz", nil},  -- alliance
	{2, 12, 0.762, 0.511, "Tiefenbahn nach Sturmwind", "tram", "Allianz", nil},  -- alliance
	{2, 17, 0.812, 0.794, "Schiff nach Funkenwasser Hafen", "boat", "Horde", nil}, -- horde
	{2, 27, 0.068, 0.613, "Schiff nach Theramore", "boat", "Allianz", nil},  -- alliance
	{2, 26, 0.218, 0.563, "Schiff nach Auberdine", "boat", "Allianz", nil}, -- alliance
	{2, 23, 0.257, 0.73, "Schiff nach Ratschet", "boat", "Neutral", nil}, -- neutral
	{2, 30, 0.616, 0.571, "Zeppeline nach Orgrimmar & Grom’gol", "zepp", "Horde", nil}, -- horde
	...
	{2, 26, 0.617, 0.761, "Mail", "mail", "Allianz", nil},
	{2, 26, 0.598, 0.752, "Gasthaus", "gh", "Allianz", nil},
